...
export {
  ...
  // §5.5 #17-12 ③-7 — 실패 문장이 부를 엔진 이름(제품 고유명사 · 번역하지 않는다).
  AGENT_ENGINE_CLI_LABEL,
  UNKNOWN_ENGINE_CLI_LABEL,
  // §2.4 — 한도 정지로 고쳐 적어도 되는 실패 사유(서버가 사유를 고를 때 · 회귀 시험이 같은 목록을 본다).
