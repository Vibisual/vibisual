...
function KindIcon(
  ...
  if (kind === 'critique') {
    return <svg {...p} aria-label={t('bubbleMap.taskEdge.critiqueIconLabel')}><path d="M2 12 Q12 4 22 12 Q12 20 2 12 Z" /><circle cx="12" cy="12" r="3" fill="currentColor" stroke="none" /></svg>;
  }
  if (kind === 'artifact') {
